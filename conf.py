...
# sphinx-quickstart on Wed Feb 17 14:21:59 2016.
#
...
project = 'Insigneo Mailing list and Google group creation'
copyright = '2016, Insigneo'
publisher = 'Insigneo'
...
latex_documents = [
    (master_doc, 'insigneo_template.tex', project,
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'insigneo_template', project,
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Template', 'Insigneo Template',
